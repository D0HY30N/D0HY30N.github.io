...
- Fuwari를 기반으로 한 테마 코드는 원작자의 [MIT License](./LICENSE)를 따릅니다.
- 블로그 게시글의 기본 라이선스는 [CC BY-NC-SA 4.0](https://creativecommons.org/licenses/by-nc-sa/4.0/)입니다.
- 개인 사진과 직접 제작한 미디어의 저작권은 D0HY30N에게 있습니다.
